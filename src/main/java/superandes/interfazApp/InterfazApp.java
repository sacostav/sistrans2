...
public class InterfazApp extends JFrame implements ActionListener{
	...
	public void adicionarProducto( )
	{
		try 
		{
			...
			if (id != 0)
			{
				VOProducto tb = superandes.adicionarProducto(id, nombre, marca, precioUnitario, precioUnidad, unidadMed, volumen, peso, codigo, fecha, nivel, precioProveedor, idProveedor);
				if (tb == null)
				{
					throw new Exception ("No se pudo crear un pedido con id: " + id);
				}
	...
	public void acercaDe ()
	{
		...
		resultado += " * @author Sara acosta y Adriana Trujillo\n";
		resultado += " * \n";
		resultado += "\n ************************************\n\n";
